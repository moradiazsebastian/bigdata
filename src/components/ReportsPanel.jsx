...
function ReportsPanel({ onReportAdd, reports }) {
  ...
  return (
    <div className="w-72 bg-white border-r px-4 py-6 shadow-inner transition-all duration-300">
      <h2 className="text-lg font-semibold mb-4 capitalize">Reportes</h2>
        <div className="text-gray-600 text-sm">
          {reports.length === 0 ? (<p className="text-gray-500">Aun no hay reportes cargados.</p>) : (
